...
/**
 * Created by Madhuri Patil , Nashik on 3/1/18.
 */
...
//    }
    ...
    public static void showErrorMessage(VolleyError error , Activity activity)
    {
        String errorMsg = VolleyErrorHelper.getErrorType(error, activity);
        AlertDialogUtils.showCustomAlertDialog(activity, errorMsg);
    }
}
